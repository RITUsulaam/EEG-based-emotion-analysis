...
def convertData():
    ...
    fout_data = open("F:/8th sem project/data_preprocessed_python/features_raw.dat",'w')
    fout_labels0 = open("F:/8th sem project/data_preprocessed_python/labels_0.dat",'w')
    fout_labels1 = open("F:/8th sem project/data_preprocessed_python/labels_1.dat",'w')
    fout_labels2 = open("F:/8th sem project/data_preprocessed_python/labels_2.dat",'w')
    fout_labels3 = open("F:/8th sem project/data_preprocessed_python/labels_3.dat",'w')
